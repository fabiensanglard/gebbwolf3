...
\begin{figure}[H] \centering \includegraphics[width=\textwidth]{imgs/drawings/fizzlefade/fibonnaci.png} \end{figure}
...
\begin{figure}[H]
  \centering
 \includegraphics[width=\textwidth]{screenshots/palette_damage.png}
