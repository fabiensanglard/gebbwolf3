...
\begin{figure}[H]
  \centering
\scaledimage{0.8}{w3dvr/multiplayer.png}
 
\end{figure}

\begin{figure}[H]
  \centering
\scaledimage{0.8}{w3dvr/station.png}
...
\end{figure}
\par
Tom Hall helped Cybertag by going on-site in Tennessee for two days. About ten new maps were specially designed for deathmatch while some were  simplyfied version of the adventure mode.\\
\par
\begin{fancyquotes}
...
The engine seems to have had a crude communication with the display via a driver at a hard-coded location (segment \cw{0x40}, offset \cw{0x40}). Each frame, the viewing angle was retrieved from the driver and a view rendered. There was no synchronization system to make sure both eyes were rendered without simulation time increase so the resulting effect must have been weird at times.\\
\par
