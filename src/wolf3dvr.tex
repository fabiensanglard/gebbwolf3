...
\textbf{\underline{Trivia :}} Wolfenstein VR remains on the MAME project's "Undumped" list to this day.

\begin{figure}[H]
  \centering
 \scaledimage{0.9}{w3dvr/title.png}
 
\end{figure}

\begin{figure}[H]
  \centering
\scaledimage{0.9}{w3dvr/multiplayer.png}
...
\begin{figure}[H]
  \centering
\scaledimage{0.9}{w3dvr/game.png}
