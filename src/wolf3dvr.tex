...
\begin{figure}[H]
  \centering
 \includegraphics[scale=0.5]{imgs/w3dvr/title.png}
 \caption{Title screen}
\end{figure}

\begin{figure}[H]
  \centering
 \includegraphics[scale=0.5]{imgs/w3dvr/multiplayer.png}
 \caption{Title screen}
\end{figure}

\begin{figure}[H]
  \centering
 \includegraphics[scale=0.5]{imgs/w3dvr/station.png}
 \caption{Title screen}
\end{figure}

\begin{figure}[H]
  \centering
 \includegraphics[scale=0.5]{imgs/w3dvr/game.png}
 \caption{Title screen}
\end{figure}
