\section{Audio and Heatbeats System}
The audio and hearbeat system run concurently with the rest of the program. On an operating system supporting neither processes nor threads that means using interrupts to stop normal execution and perform tasks on the side.\\
\par
...
The PIC's IRQ0-IRQ8 is mapped to the Interrupt Vector Offset 8 (resulting in mappoing to INT08-INT0F).\\
