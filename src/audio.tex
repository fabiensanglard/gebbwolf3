...
\end{minipage}
\par
Strangely, only PC speaker and AdLib sounds are stored in the \cw{AUDIOT.*} files, the digitized sounds are in the \cw{VMSWAP.*} archive. As a result, offset \cw{STARTDIGISOUNDS} is never used.\\
