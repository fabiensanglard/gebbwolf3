Wolfenstein 3D was not the first FPS the team produced. Back when they still had obligations to Softdisk, they worked on two games: Hovertank One and Catacomb 3-D.\\
\par
...
\begin{figure}[H]
\centering
\scaledimage{0.85}{Hovertank_3D_title_screen.png}
\end{figure}

\begin{figure}[H]
\centering
\scaledimage{0.85}{Hovertank_3D_screen.png}
\end{figure}
\end{minipage}
