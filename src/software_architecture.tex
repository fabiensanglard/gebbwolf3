...
With the big picture in mind, we can dive into the code and unrolling the main loop (hence starting at \cw{int main()} to reveals two renderers (the sound system is interrupt driven and therefore is out of \cw{main}).\\ An important precision about data types: Because the game is using Real Mode (emulated 16 bits architecture), C types don't mean what people would expect from a 32 bits architecture.\\
\par 
\begin{itemize}
...
\begin{figure}[H]
\centering
 \includegraphics[width=\textwidth]{imgs/drawings/cache_manager_architecture.png}
 \end{figure}
 \par
...
\begin{figure}[H]
\centering
 \includegraphics[width=\textwidth]{imgs/drawings/sound_manager_architecture.png}
 \end{figure}
 \par
...
\begin{figure}[H]
\centering
 \includegraphics[width=\textwidth]{imgs/drawings/vga_layout/wasted_vga_ram.png}
...
\begin{figure}[H]
\centering
 \includegraphics[width=\textwidth]{imgs/drawings/vga_layout/vga_ram_architecture.png}
 \caption{3D View as is appears on screen} \label{fig:vga_layout_in_3D}
 \end{figure}
\par
...
As a result from unchaining a complete framebuffer is divided into four banks. Horizontally it looks a little bit like mashed potatoes:
 \begin{figure}[H]
\centering
 \includegraphics[width=\textwidth]{screenshots/vga_layout/intro.png}
 \caption{Intro screen as it appear on screen}
 \end{figure}
 \par
 \begin{figure}[H]
\centering
 \includegraphics[width=\textwidth]{screenshots/vga_layout/intro_bank.png}
...
\begin{figure}[H]
\centering
 \includegraphics[width=\textwidth]{screenshots/vga_layout/wolf3d_7.png}
 \caption{3D View as is appears on screen} \label{fig:vga_layout_in_3D}
 \end{figure}
 \par
 ...
 \begin{figure}[H]
\centering
 \includegraphics[width=\textwidth]{screenshots/vga_layout/wolf3d_7_bank.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{screenshots/pg13.png}
\caption{Architecture and sub-systems.}
\end{figure}
