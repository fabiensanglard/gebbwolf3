...
\centering
 ...
 \end{figure}
\par
Showing part of one page and page of an other page and also unaligned.\\The problem has to do with atomicity. Updating the CRTC starting address is 16-bits adress...but it can only be updated with 8-bits write operation. IT is not atomic. If you are unlucky, the CRTC could pickup the scan address just here:\\
\par
\par
\begin{minipage}{\textwidth}
