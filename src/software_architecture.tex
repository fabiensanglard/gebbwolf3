...
\par
\bu{Trivia :} Is there a typo in the filename \cw{AUDIOHED.WL} ? Correct spelling would be \texttt{\justify AUDIOHEAD.WL1}. Where is the \cw{A}? This is in fact a limitation of the operating system. DOS only allows 8.3 filename (at most eight characters followed by a dot, then at most three characters for the extension.)
