...
\centering
 ...
 \end{figure}
 \par
 The architecture of the Page Manager is interesting since it treats XMS as a last resort L2 cache level while EMS RAM is used like conventionnal memory. This is because EMS driven RAM is several time faster than XMS driven RAM. This topic is detailled in Annexe \ref{ems_vs_xms} on page \pageref{ems_vs_xms}\\
 \par
