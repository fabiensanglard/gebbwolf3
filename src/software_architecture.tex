...
\centering
 ...
 \end{figure}
 \par
 \note{Why is EMS better than XMS? Both rely on banking. Something does not add up here. I must have misunderstood the code.}
...
The real magic is in function \cw{VL\_DePlaneVGA} where VGA registers are manipulated directly. \\
