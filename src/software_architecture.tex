...
d\item 3D game renderer where the player spends most of her time.
...
\par
This code can run without issues at 70 frames per second since just 200 slow \cw{outp} instructions are used.\\
\par
