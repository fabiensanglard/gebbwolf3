...
\rawscaleddrawing{0.9}{timeline}%{Development timeline}
...
\end{figure}
\par
Borland solution was an all-in-one package. The IDE, \cw{BC.EXE}, despite some instabilities allowed crude multi-windows code editing with pleasant syntax highlights. Compiler and Linker were also part of the package under \cw{BCC.EXE} and \cw{TLINK.EXE}\footnote{Source: Borland C++ 3.1 User Guide.}.
\pagebreak
...
\par 
 ...
 \par
 \vspace{-7pt}
The comments still fit perfectly once screen since only the vertical resolution is doubled.\\
\par
\vspace{-4pt}
 \fullimage{borland_ide_highres.png} 
 The same \cw{WL\_MAIN.C} opened in both mode demonstrate the trade off readability/visibility.\\
\par
