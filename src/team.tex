...
\begin{figure}[H]
\centering
 \includegraphics[scale=0.6]{map/usa-id-software.eps}
 \end{figure}
...
Insight into asset production show Tom Hall sketches before they were created by Adrian Carmack.\\
  ...
  \begin{figure}[H]
\centering
 \includegraphics[scale=1.0]{imgs/tom_hall_sketch_adolf.png}
 \caption{3D Rendere Phase 1: Backed lights}
 \end{figure}
 
   \begin{figure}[H]
\centering
 \includegraphics[scale=1.3]{imgs/tom_hall_sketch_dr_schabbs.png}
 \caption{3D Rendere Phase 1: Backed lights}
 \end{figure}
 
   \begin{figure}[H]
\centering
 \includegraphics[scale=1.3]{imgs/tom_hall_sketch_gretel.png}
 \caption{3D Rendere Phase 1: Backed lights}
 \end{figure}
 
   \begin{figure}[H]
\centering
 \includegraphics[scale=0.6]{imgs/tom_hall_sketch_intro_screen_genesis.png}
 \caption{3D Rendere Phase 1: Backed lights}
 \end{figure}
 
   \begin{figure}[H]
\centering
 \includegraphics[scale=1.3]{imgs/tom_hall_sketch_officer.png}
 \caption{3D Rendere Phase 1: Backed lights}
 \end{figure}
 
   \begin{figure}[H]
\centering
 \includegraphics[scale=1.3]{imgs/tom_hall_sketch_officer2.png}
 \caption{3D Rendere Phase 1: Backed lights}
 \end{figure}
 
    \begin{figure}[H]
\centering
 \includegraphics[scale=1.3]{imgs/adrian_carmack_paper_sketch.png}
 \caption{3D Rendere Phase 1: Backed lights}
 \end{figure}
