...
\stepcounter{footnote}
 ...
 \stepcounter{footnote}
 \footnotetext{Jason wrote part of the page manager and is credited for introducing John Carmack to Unix development, which ultimately led to the purchase of a Next ColorStation. He left a few months after the creation of id.}
...
\textbf{\underline{Trivia :}} The engine is very tiny and only uses 94KiB in total. But with 64KiB of the executable dedicated to the \cw{Signon} screen (and 768 bytes for the palette), the engine is in fact only 29KiB.\\
\par
\begin{figure}[H]
\centering
\label{disquette}
