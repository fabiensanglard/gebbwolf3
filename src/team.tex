...
\end{itemize}
During Winter 1991 the next generation of if Software technology started to appear. The first one allowed the player to be inside a tank (Hovertank 3D). The second one took the immersion one step further placing it in control of a magician in First Person mode (Catacomb 3D). And now they were free from SoftDisk. And the next title was going to be called Wolfenstein 3D.\\
\par 
