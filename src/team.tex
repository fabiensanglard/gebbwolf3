...
\centering
 ...
 \end{figure}
\note{Why did they move there? Climat ?}
...
The game was distributed via shareware. Only the game engine and the first episode of the game were given for free and encouraged to be copied and distributed to a maximum number of peoples. To receive the five other episodes, each player had to send \$50 to id Software.\\
\par
\begin{figure}[H]
\centering
...
\textbf{\underline{Trivia :}}The engine is very tiny and only uses 94KB in total. But with 64KB dedicated to the Signon screen (and 768B for the palette), the engine is in fact only 29KB.\\