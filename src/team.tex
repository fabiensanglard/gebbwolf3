...
TODO: Drawing of AUDIOT format (compressed with huffman) with pc speaker, adlib and digitized effects.
...
Because Sound Blaster was trying to overtake Adlib, it shipped with the same yamaha processor. Music only had to be in one format. But sound effects had to be in three.
