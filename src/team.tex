...
\stepcounter{footnote}
 \footnotetext{Bobby had worked with id Software before on Keen 4-6 as a contractor but was never a full-time employee.}
 \stepcounter{footnote}
...
\begin{minipage}{\textwidth}
 ...
 \par
 The \cw{DICT} file contains the Huffman tree to decompress the assets, this is further discussed in the Cache Manager section on page \pageref{cache_manager}.\\
