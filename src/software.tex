...
\begin{document}
\section{Source Code}
The game engine was uploaded on the later legendary ftp.idsoftware.com.\\
\textbf{\underline{Trivia :}} Even after all these years ftp.idsoftware.com is still up and running. Try it, open your command-line: ftp ftp.idsoftware.com and find all the source code released over the year by id Software in the folder idstuff.\\
