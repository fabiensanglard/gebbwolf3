...
Released in the United States in March 1994, The port to Super Nintendo was done during the development of Doom. id Software originally intended to subcontract the port but the guy in charge of port failed to deliver.\\
\par
 \begin{fancyquotes}
Disaster Struck.\\
\par
...
\begin{figure}[H]
\centering
 \scaledimage{0.8}{jaguar_port_cover.jpg}
\end{figure}
\par
\begin{figure}[H]
\centering
