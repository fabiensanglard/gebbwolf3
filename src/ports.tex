...
\centering
 ...
 \end{figure}
 \par
The NES used an extremely low resolution in 3D scenes: 125x125! (But the HUB and weapon are higher resolution which helps a little.)
...
\end{figure}
\par
Notice the 4:3 aspect ratio mandated by 1992 TV dimensions. The machine gun sprite was not the one from Wolf3D PC but the one from Doom.\\
