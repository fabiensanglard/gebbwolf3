...
\section{Jaguar}
The Jaguar port was done within a few weeks of 1994 by John Carmack going "vampire mode"\footnote{Source: "To Hell and Back Again". Computer Gaming World No. 120.}. It was was noteworthy for being the only port able to reach 60 frames per seconds at 240p resolution (320x240 with blurring due to NTSC), and introducing two new weapons: the Flamethrower and Rocket Launcher.\\
\par
