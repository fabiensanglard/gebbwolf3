...
\begin{itemize}
 ...
 \item Finally there are $2^{23}$ offsets available so 3.14 is at $\frac{3.14 -2 }{4 - 2} = 0.57 $. The mantissa/offset $\rightarrow M = 2^{23}*0.57 = 4781507$
\end{itemize}
