...
The first adapter of the family was released in 1981. The Monochrome Display
   Adapater (\codeword{MDA}) was monochrome with low resolutions but it had the merit to be on every PC sold. Many other systems followed over the years, always preserving backward compatibility like it was the tradition at the time:
\bigskip
...
\caption{VGA Modes available from BIOS.}\label{fig:vga_modes}
 ...
 Programmers started to reference VGA modes. It was a common thing to see tutorial about Mode 12h or Mode 13 which were the two most appealing mode for game programming.
...
Finally, sound card connected via the ISA bus provided a new port: A Game Port (DA-15) allowing to connect a joystick.
 \begin{figure}[H]
\centering
