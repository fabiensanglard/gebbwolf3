...
The XMS driver works\footnote{eXtended Memory Specification (XMS) July 19, 1988.} like \cw{malloc}/\cw{free} from \cw{libc} and is the most intuitive to a programmer. It allows manipulation of data in the non-addressable extended memory via operations such as \cw{allocate}, \cw{free}, \cw{realloc}, and \cw{move}.\\
\par
% \begin{enumerate}
%  \item \cw{allocate}
%  \item \cw{free}
