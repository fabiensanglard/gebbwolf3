...
\par
 ...
 The first mode commonly considered for game programming is mode \cw{12h}. It offers a resolution of 640x480 at 60hz\footnote{Oddly, this mode is the only one to work at 60Hz. All others run at 70Hz.} with 16 colors. Each pixel is encoded in 4 bits (a nibble) spread across the four banks.\\
\par
