...
\end{figure}
\par
Above, a VGA card Trident 8800 (8 bits ISA). Courtesy of \cw{vgamuseum.info}. Notice the eight chip of 32 KiB (for a total of 256KiB) on the left of the card where the framebuffers are stored.
\par
\begin{figure}[H] 
  \centering 
