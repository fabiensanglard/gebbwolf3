...
\par
\textbf{\underline{Trivia :}}  This 640KB barrier was a big issue. Many customer could not understand why, even though they had many (extremly expensive\footnote{In 1992, 4MB of RAM costed \$149 which ajusted to inflaction would be \$256 in 2016}) megabytes of RAM installed on their machine, some game would refuse to start up claiming "Not enough memory". id Software had to publish an explanation (Appendix "\nameref{chap:barrier640}") along with the game to make it clear that it was not their fault.\\
...
\par
 \begin{fancyquotes}
   ...
   \\
\textbf{David A. Patterson \& John L. Hennessy - Computer Organization and Design.}
 \end{fancyquotes}\\
