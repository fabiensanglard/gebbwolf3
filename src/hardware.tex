...
\end{itemize}
 ...
 \begin{figure}[H]
\centering
 \includegraphics[width=\textwidth]{screenshots/wolf3d_ega.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{screenshots/circleframebuffer.png}
  \caption{Drawing a circle in the framebuffer}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{screenshots/circlescreen.png}
