...
\begin{tabularx}{\textwidth}{ X X  }
  ...
  CPU & Poor \\ \bottomrule
\end{tabularx}
\caption{Component quality for a game engine\footnote{Even though the CPU was powerful it was very good only at something next to useless for a 3D engine: Integer arithmetic.}  \label{fig:Component quality for a game engine.}
\end{figure}
