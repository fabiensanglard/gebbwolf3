...
\begin{figure}[H] 
  ...
  \caption{The VGA card Trident 8800 (8 bit ISA). Courtesy of \cw{vgamuseum.info}. Notice the eight chips on the left of the card forming the VRAM where the framebuffers are stored\protect\footnotemark.}
\end{figure}
