...
The XMS driver works\footnote{eXtended Memory Specification (XMS) July 19, 1988.} like \cw{malloc}, providing operations such as \cw{allocate}, \cw{free}, \cw{realloc} and the most important one \cw{move} which allows copying from extended RAM to conventional RAM.
