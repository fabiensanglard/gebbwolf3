...
\end{figure}
\par
Above, a VGA card Trident 8800 (8 bit ISA). Courtesy of \cw{vgamuseum.info}. Notice the eight chip of 32 KiB (for a total of 256KiB) on the left of the card where the framebuffers are stored.
\par
\begin{figure}[H] 
  \centering 
  \fullimage{hardware/diamond_stealth_vram_revb2.png} 
  \caption{A VGA card Diamond Stealth (16 bit ISA). Courtesy of \cw{vgamuseum.info}.}
\end{figure}
