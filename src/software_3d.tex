...
With each state are associated \cw{think} and \cw{action} method pointers. There is also a \cw{next} pointer to indicate which state the actor should transit when the current state is completed.\\
\par
\begin{minipage}{\textwidth}
