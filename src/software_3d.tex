...
\par
This part of the code relies heavily on the trigonometric circle principles:
\begin{figure}[H]
\centering
...
Note: "Thinking" screenshot here to show scaler have to be regenerated.\\
\begin{figure}[H]
 \centering
...
\par
The same "draw" multiple column at once is used. Is it especially powerful when enemy are magnified.\\
...
\begin{figure}[H]
 \centering
 \fullimage{magnified_enemy_after.png}
\end{figure}
