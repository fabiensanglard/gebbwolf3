...
\par
 ...
 E.G: Player position is 24:8, to get grid location just remove fraction part.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{imgs/ray_caster_explained/marked_out_room.pdf}
...
\begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{imgs/triple_pages_trick.pdf}
\end{figure}
\par
...
\begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{imgs/triple_pages_trick_padding.pdf}
\end{figure}
\par
...
\begin{figure}[H]
 \centering
 \includegraphics[width=.75\textwidth]{imgs/sound_area/map.pdf}
\end{figure}
\par
...
\begin{figure}[H]
 \centering
 \includegraphics[width=.75\textwidth]{imgs/sound_area/area.pdf}
\end{figure}
\par
...
\begin{flushright}
\includegraphics[width=0.98\textwidth]{imgs/ambush/map_unknown_drawing.pdf}
\end{flushright}  
\end{minipage}
\noindent
\\
...
\begin{minipage}{0.4\textwidth}
\begin{flushright}
\includegraphics[width=0.98\textwidth]{imgs/ambush/map_ambushed_drawing.pdf}
\end{flushright}
\end{minipage}
\noindent
\\
