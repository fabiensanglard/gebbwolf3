...
\par
What makes rays similar? The answer is two rays hitting the same wall and resulting in the same texture coordinate. In short this trick leverage wall magnification. In the following screenshots, the player is very close to a wall which completely cover the left part of the screen. It is obvious that the texture is magnified. Multiple consecutive rays hit a texture at the same horizontal coordinate:
\begin{figure}[H]
 \centering
