...
\begin{enumerate}
 ...
 \item From the player's perspective (location and direction), cast rays for each column of pixel (320), ending when they hit a wall. Render a textured pixel column which high is inversely proportional to its distance from the player.
...
\par
Can you find the path to Aardwolf? The solution is on page \pageref{aardwold_solution}. \\
\begin{fancyquotes}
