...
\begin{enumerate}
 ...
 \item From the player's perspective, cast rays for each pixel column, ending when they hit a wall. Calculate the collision distance and render a textured pixel column inversely proportional to this distance.
