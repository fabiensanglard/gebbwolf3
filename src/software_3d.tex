...
\par
 But there is a faster way to do it which involves the eternal RAM vs CPU tradeoff. In this case we can give away a bit of RAM to gain a lot of CPU.\\
 \par 
...
\par
What is the RAM cost incured by precompiling these scalers? How much RAM does it use? It takes 1 + 7 instructions per pixel written to scale a column. If all size were generated from 2,4,6...152 (76 values for 38 pairs), we can use Gauss method to calculate the size:\\
\par
...
\bu{Trivia :} Textures are stored on HDD and RAM rotated 90 degres. This is because they are rendered as columns. It is easier to calculate offsets this way.\\
\par
