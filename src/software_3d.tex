...
\begin{fancyquotes}
Why a raytracer instead of a rasterizer?\\
\par
...
DDA stands for Digital Differential Analysis. It is an algorythm widely used in computer graphic to draw a line.\\
...
\subsection{Precompiled scalers}
One of the secret of the the speed of the engine was its pre-compiler scalers. These scalers are used to draw all walls and sprites. As see in the following screenshots:
\par
 \begin{figure}[H]
\centering
