...
Notice how the length of each ray correspond the height of a column in order to achieve perspective. The bigger the distance the ray traveled, the smaller the column appear on screen.
 \end{minipage}
