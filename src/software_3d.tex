...
Drawing the weapon at the bottom is straight forward. It uses the same type of rendition for sprite but with specific code where clipping is disabled. Because weapon sprites features transparency it cannot be rendered with precompiled scaler.\\ \cw{ScaleShape}
\par
