...
But Game console were designed around animation. They all had coprocessors and Graphic Unit relying on tile engine. Animating a sprite on the screen was just about to update its $(x,y)$ coordinates.\\
\\
