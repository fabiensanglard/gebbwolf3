...
\textbf{John Carmack - Programmer}
 \end{fancyquotes}\\
\\
Opening the code did not only enable modding and educate programmers. It had two unforeseen consequences.\\
\\
...
\end{itemize}
On top of these major blockers lied a myriad of major difficulties:\\
\begin{itemize}
