...
\begin{itemize}
\item Chapter 1: The Hardware. The five components of a PC from 1991.
\item Chapter 2: The Team\footnote{This is an engineering book. For the human aspect read David Kushner's chef d'oeuvre: "Masters of Doom".}. The people pushing the edges.
\item Chapter 3: The Software. The Wolfenstein 3D game engine.
\end{itemize}
\par
