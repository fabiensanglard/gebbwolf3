...
So the IBM PC with its fast CPU and 256K framebuffer looked promising except there was three seemingly impossible\footnote{The title of this book was almost: "The Impossible Machine".} to overcome obstacles:\\
\begin{itemize}
...
\item The PC Speaker, the only sound device present on all PCS could only produce one tune: "Beeeeeeeeeep" which was more annoying than anything.
\end{itemize}
